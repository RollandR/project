...
//On vérifi que ces fichier ne sont appelé qu'une fois
...
// on regarde si les variables sont vides
    ...
    <form action="Connexion.php" method="post" enctype="multipart/form-data" id="form_article">
        <div class="form-row">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" id="inputmdp" name="mdp"  placeholder="MDP" required>
            </div>
